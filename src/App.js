...
function Calc({theUserId}) {
    ...
    const addCharacter = (e) => {
        e.preventDefault()
        const player_character = {name, user_id: userId, description, crit_range: critRange, attack_mod: attackMod, num_of_attacks: numOfAttacks, has_adv: hasAdv, standard_die_list: standardDiceData, standard_dam_mod: standardDamageMod, first_hit_die_list: firstHitDiceData, 
